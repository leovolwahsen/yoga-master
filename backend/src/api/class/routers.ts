...
classRouter.post("/new-class", verifyInstructor, classController.createClass);
classRouter.get("/classes", classController.getAllClasses);
classRouter.get("/class/:id", classController.getClassById);
classRouter.get("/class/:email", verifyInstructor, classController.getClassByEmail);
classRouter.get("/classes-manage", classController.getManagedClasses);
classRouter.patch("/change-status/:id", verifyAdmin, classController.updateClassStatusById);
classRouter.get("/approved-classes", classController.getApprovedClasses);
classRouter.put("/update-class/:id", verifyInstructor, classController.updateClassById);
